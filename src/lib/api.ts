...
export function subscribeToLocationUpdates(rideId: string, callback: (location: Record<string, unknown>) => void) {
...
export function subscribeToNotifications(userId: string, callback: (notification: Record<string, unknown>) => void) {
  const subscription = supabase
...
export function subscribeToRideUpdates(rideId: string, callback: (ride: Record<string, unknown>) => void) {
  const subscription = supabase
